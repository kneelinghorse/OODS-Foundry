...
if (process.env.GITHUB_HEAD_REF && process.env.GITHUB_HEAD_REF.includes('smoke-a11y')) {
  console.error(`[a11y-contract] Intentional smoke failure (phase 1) for branch ${process.env.GITHUB_HEAD_REF}`);
  process.exit(1);
}

...
`examples/viz/patterns/` and are rendered inside Storybook at
...
| --- | --- | --- | --- | --- |
| Grouped Bar | Bar | 1Q + 2N (category × comparison) | 0.93 (High) | `examples/viz/patterns/grouped-bar.spec.json` |
| Stacked Bar | Bar | 1Q + 2N (part-to-whole) | 0.90 (High) | `examples/viz/patterns/stacked-bar.spec.json` |
| 100% Stacked Bar | Bar | 1Q% + 2N (normalized mix) | 0.88 (High) | `examples/viz/patterns/stacked-100-bar.spec.json` |
| Diverging Bar | Bar | 1Q (±) + 1N | 0.82 (Medium) | `examples/viz/patterns/diverging-bar.spec.json` |
| Multi-series Line | Line | 1Q + 1T + 1N | 0.95 (High) | `examples/viz/patterns/multi-series-line.spec.json` |
| Trend vs Target Band | Line | 3Q + 1T | 0.86 (Medium) | `examples/viz/patterns/target-band-line.spec.json` |
| Running Total Area | Area | 1Q + 1T | 0.91 (High) | `examples/viz/patterns/running-total-area.spec.json` |
| Bubble Distribution | Scatter | 3Q + 1N | 0.84 (Medium) | `examples/viz/patterns/bubble-distribution.spec.json` |
| Correlation Scatter | Scatter | 2Q + 1N | 0.90 (High) | `examples/viz/patterns/correlation-scatter.spec.json` |
| Time Grid Heatmap | Heatmap | 1Q + 2N | 0.92 (High) | `examples/viz/patterns/time-grid-heatmap.spec.json` |
| Correlation Matrix | Heatmap | 1Q + 2N (symmetric) | 0.85 (Medium) | `examples/viz/patterns/correlation-matrix.spec.json` |
...
- **Spec**: `examples/viz/patterns/grouped-bar.spec.json`
...
- Spec: `examples/viz/patterns/stacked-bar.spec.json`
...
- Spec: `examples/viz/patterns/stacked-100-bar.spec.json`
...
- Spec: `examples/viz/patterns/diverging-bar.spec.json`
...
- Spec: `examples/viz/patterns/multi-series-line.spec.json`
...
- Spec: `examples/viz/patterns/target-band-line.spec.json`
...
- Keep the baseline anchored to zero and narrate increments in the table
  fallback.
- Spec: `examples/viz/patterns/running-total-area.spec.json`
...
- Spec: `examples/viz/patterns/bubble-distribution.spec.json`
...
- Spec: `examples/viz/patterns/correlation-scatter.spec.json`
...
- Spec: `examples/viz/patterns/time-grid-heatmap.spec.json`
...
- Spec: `examples/viz/patterns/correlation-matrix.spec.json`

...
<Meta title="Understanding OODS/Brownfield Adoption" />

# Brownfield Adoption — Incremental Integration
...
### Component Migration: Legacy → OODS
...
**Benefits:**
- ✅ Semantic intent mapping (no hardcoded colors)
- ✅ Automatic WCAG AA compliance
- ✅ HC mode support with outline
...
### Phase 2: Components
- ✅ **Component migration:** 80%+ components using OODS traits
- ✅ **Accessibility score:** &lt;5 serious/critical axe violations
- ✅ **Context adoption:** 100% pages with context wrappers

### Phase 3: Objects
- ✅ **Object coverage:** 100% domain entities with OODS objects
- ✅ **Validation coverage:** 100% API endpoints with validation
- ✅ **Type safety:** 100% generated types with no `any`

### Phase 4: Compliance
- ✅ **RBAC coverage:** 100% privileged actions gated
- ✅ **Audit completeness:** 100% critical actions logged
- ✅ **Tenant isolation:** 100% cross-tenant leak tests passed
...
3. **Plan your first phase** (most teams: Phase 1 → 2 → 3 → 4)

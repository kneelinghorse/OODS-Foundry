...
<Meta of={StepperStories} title="Primitives/Navigation/Stepper/Guidelines" />
...
- Keep labels short (2–3 words) and add `description` copy when the step requires extra context.  

 ...
 * Canonical account record for tenant and workspace governance across the platform, now supporting broadcast messaging via Communicable and preference governance for delivery controls.
 *
 ...
 * Traits: Labelled, Stateful, Ownerable, Timestampable, Taggable, Addressable, Authable, Preferenceable, Communicable
 */
...
export interface Organization {
   ...
   */
  broadcastMessage?(recipientIds: string[], template: import('@/schemas/communication/template.js').Template, variables?: import('@/schemas/communication/message.js').MessageVariables): import('@/traits/communication/runtime-types.js').MessageDeliveryResult;
   ...
   * Source: Communicable (trait helper)
   */
  getChannels?(): import('@/schemas/communication/channel.js').Channel[];
   ...
   * Source: Communicable (trait helper)
   */
  getTemplates?(channelType?: string): import('@/schemas/communication/template.js').Template[];
   ...
   * Source: Communicable (trait helper)
   */
  getDeliveryPolicies?(): import('@/schemas/communication/delivery-policy.js').DeliveryPolicy[];
   ...
   * Source: Communicable (trait helper)
   */
  getSLAMetrics?(window: string | number): import('@/traits/communication/sla-monitor.js').SLAMetrics;
}

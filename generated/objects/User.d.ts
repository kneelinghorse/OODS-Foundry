 ...
 * Canonical identity record representing a platform user across lifecycle contexts, now including messaging capabilities via Communicable.
 *
 ...
 * Traits: Stateful, Timestampable, Taggable, Addressable, Preferenceable, Authable, Communicable
 */
...
export interface User {
   ...
   */
  sendMessage?(recipientIds: string[], template: import('@/schemas/communication/template.js').Template, variables?: import('@/schemas/communication/message.js').MessageVariables): import('@/traits/communication/runtime-types.js').MessageDeliveryResult;
   ...
   * Source: Communicable (trait helper)
   */
  getMessages?(filters?: { status?: import('@/schemas/communication/common.js').MessageState; since?: string; until?: string; channelType?: string; conversationId?: string }): import('@/schemas/communication/message.js').Message[];
   ...
   * Source: Communicable (trait helper)
   */
  getConversations?(): import('@/schemas/communication/conversation.js').Conversation[];
